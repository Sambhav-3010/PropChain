  ...
  return (
    <>
      ...
      <div className="min-h-[80vh] flex items-center justify-center px-4 bg-background relative overflow-hidden">
        ...
        <div className="absolute top-20 left-10 w-32 h-32 rounded-full bg-bauhaus-red opacity-10"></div>
        <div className="absolute bottom-20 right-20 w-24 h-24 bg-bauhaus-yellow opacity-10 rotate-45"></div>
        ...
        <Card className="max-w-md w-full text-center relative overflow-hidden bauhaus-bg-pattern">
          <CardContent className="relative pt-10 pb-10 z-10">
            <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-background flex items-center justify-center shadow-[inset_4px_4px_8px_var(--neu-shadow-dark),inset_-4px_-4px_8px_var(--neu-shadow-light)]">
              <XCircle className="h-10 w-10 text-bauhaus-red" />
            </div>
            ...
            <h1 className="text-2xl font-bold text-foreground mb-2">Submission Failed</h1>
            <p className="text-muted-foreground mb-6">Please try again or contact support if the problem persists.</p>

            <Button variant="primary" asChild>
              <Link href="/register-property">Go Back to Registration</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
